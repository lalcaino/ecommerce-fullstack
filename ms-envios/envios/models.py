...
class Envio(models.Model):
    ...
    repartidor_id    = models.PositiveIntegerField(null=True, blank=True, help_text='ID del PerfilUsuario (repartidor) asignado')
    ...
    codigo_validacion = models.CharField(max_length=6, blank=True, help_text='Código de 6 dígitos para pickup')
    foto_entrega_url = models.URLField(null=True, blank=True, help_text='URL de Cloudinary con foto de entrega')
